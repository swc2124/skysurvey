...
def fsinit(halo_ebf_dir=Config.get('PATH','halo_ebf_dir')):
    '''[summary]
    ...
    for name, _path in Config.items('PATH'):
        ...
        if not os.path.isdir(_path):
            ...
            if name == 'table_dir':
                src_table_path = join(Config.get('PATH', 'src_data_path'), 'tables')
            ...
            if name == 'paper':
                src_paper_dir = join(Config.get('PATH', 'src_data_path'), 'paper')
        ...
        if not halo_fh in halos:
            ...
            if data_keys:
                ...
                for data_key in data_keys:
                    ...
                    np.save(key_fh, halo_array[data_key][::Config.getint('Data_cut', 'cut')])
            else:
